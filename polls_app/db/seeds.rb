...
ActiveRecord::Base.transaction do
  ...
  u1 = User.create!(username: 'Turan')
  u2 = User.create!(username: 'Fuat')
  u3 = User.create!(username: 'Mali')
  u4 = User.create!(username: 'Ibo')
  ...
  ac1 = AnswerChoice.create!(text: 'Loretta', question: q1)
