...
class Question
    ...
    def self.find_by_author_id(id)#tamam
      questions_data = QuestionsDatabase.get_first_row(<<-SQL, author_id: author_id)
        SELECT
          questions.*
        FROM
          questions
    ...
    def self.most_followed(n)#tamam
      QuestionFollow.most_followed_questions(n)
    end

    def self.most_liked(n)#tamam
