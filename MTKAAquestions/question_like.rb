...
class QuestionLike < ModelBase
  ...
  def self.likers_for_question_id(question_id)#tamam
  ...
  def self.liked_questions_for_user_id(user_id)#tamam
  ...
  def self.most_liked_questions(n)#tamam
  ...
  def self.num_likes_for_question_id(question_id)#tamam
