...
INSERT INTO
  replies (question_id, parent_reply_id, author_id, body)
VALUES
    ((SELECT id FROM questions WHERE title = "Earl Question"),--question_id
    (SELECT id FROM replies WHERE body = "Did you say NOW NOW NOW?"),--parent_reply_id
    (SELECT id FROM users WHERE fname = "Kush" AND lname = "Patel"),--author_id
...
VALUES 
    ((SELECT id FROM users WHERE fname = "Kush" AND lname = "Patel"),--user_id
    (SELECT id FROM questions WHERE title = "Earl Question")--question_id
);