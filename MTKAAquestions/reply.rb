...
class Reply < ModelBase
  ...
  def self.find_by_parent_id(parent_id)#tamam
  ...
  def self.find_by_user_id(user_id)#tamam
  ...
  def self.find_by_question_id(question_id)#tamam
  ...
  def parent_reply#tamam
    Reply.find_by_id(parent_id)
  end

  def child_replies#tamam
